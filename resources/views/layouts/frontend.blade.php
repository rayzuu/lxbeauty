...
<html class="no-js" lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Favicon -->
        <link rel="shortcut icon" type="image/x-icon" href="{{ secure_asset('frontend/assets/img/logo/Logo.jpeg') }}">
		
		<!-- all css here -->
        <link rel="stylesheet" href="{{ secure_asset('frontend/assets/css/bootstrap.min.css') }}">
        <link rel="stylesheet" href="{{ secure_asset('frontend/assets/css/magnific-popup.css') }}">
        ...
        <link rel="stylesheet" href="{{ secure_asset('frontend/assets/css/themify-icons.css') }}">
        <link rel="stylesheet" href="{{ secure_asset('frontend/assets/css/pe-icon-7-stroke.css') }}">
        <link rel="stylesheet" href="{{ secure_asset('frontend/assets/css/icofont.css') }}">
        <link rel="stylesheet" href="{{ secure_asset('frontend/assets/css/meanmenu.min.css') }}">
        <link rel="stylesheet" href="{{ secure_asset('frontend/assets/css/easyzoom.css') }}">
        <link rel="stylesheet" href="{{ secure_asset('frontend/assets/css/bundle.css') }}">
        ...
        <script src="{{ secure_asset('frontend/assets/js/vendor/modernizr-2.8.3.min.js') }}"></script>
    ...
    <body>
                    ...
                    <div class="container-fluid">
                        <div class="header-bottom-wrapper">
                            <div class="logo-2 furniture-logo ptb-30">
                                <a href="/">
                                    <img height="60" style="transform:scale(1.5);object-fit: cover;" src="{{ asset('frontend/assets/img/logo/Logo.jpeg') }}" alt="">
                                </a>
                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="furniture-bottom-wrapper">
                            ...
                            <div class="furniture-search">
                                <form>
                                    <input placeholder="Search" type="text" name="search" autocomplete="off" id="search">
                                    <button disabled>
                                        <i class="ti-search"></i>
                                    </button>
                                </form>
                            ...
                            <div class="furniture-wishlist">
                                <ul>
                                    <li>
                                        <a href="{{ route('favorite.index') }}"><i class="fas fa-heart"></i> Favorites</a>
                                    </li>
                                    @auth
                                    <li>
                                        <a href="{{ route('orders.index') }}"><i class="fas fa-shopping-bag"></i>
                                            Orders</a>
                                    </li>
                                    @endauth
                                </ul>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-3 col-10 col-lg-4 col-xl-3 mx-auto mb-4">
                            ...
                            <h6 class="text-uppercase fw-bold mb-4">
                                <i class="fas fa-gem me-3"></i>LxBeauty
                            </h6>
                            <p>
                                Beauty is pain.
                            </p>
                        ...
                        <div class="col-md-3 col-10 col-lg-2 col-xl-2 mx-auto mb-4">
                            ...
                            <p>
                                <a href="{{ route('shop.index') }}" class="text-reset">Product</a>
                            </p>
                            <p>
                        ...
                        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                            ...
                            <p><i class="fas fa-home me-3"></i> Kel Grendeng</p>
                            <p>
                                <i class="fas fa-envelope me-3"></i>
                                zidaneraihan24@gmail.com
                            </p>
                            <p><i class="fas fa-phone me-3"></i> 081385236632</p>
                        </div>
                        <!-- Grid column -->
                    </div>
                    <!-- Grid row -->
        ...
        @livewireScripts
		<!-- all js here -->
        <script src="{{ secure_asset('frontend/assets/js/vendor/jquery-1.12.0.min.js') }}"></script>
        <script src="{{ secure_asset('frontend/assets/js/popper.js') }}"></script>
        <script src="{{ secure_asset('frontend/assets/js/bootstrap.min.js') }}"></script>
        <script src="{{ secure_asset('frontend/assets/js/jquery.magnific-popup.min.js') }}"></script>
        <script src="{{ secure_asset('frontend/assets/js/isotope.pkgd.min.js') }}"></script>
        <script src="{{ secure_asset('frontend/assets/js/imagesloaded.pkgd.min.js') }}"></script>
        <script src="{{ secure_asset('frontend/assets/js/jquery.counterup.min.js') }}"></script>
        <script src="{{ secure_asset('frontend/assets/js/waypoints.min.js') }}"></script>
